...
CREATE TABLE effectifs (
    ...
    taille_cm INT NULL,
    gestalt VARCHAR(50) NULL,
    gesicht VARCHAR(50) NULL,
    haar VARCHAR(50) NULL,
    bart VARCHAR(50) NULL,
    augen VARCHAR(50) NULL,
    besondere_kennzeichen TEXT NULL,
    schuhzeuglaenge VARCHAR(20) NULL,
    schuhzeugweite VARCHAR(5) NULL,
    blutgruppe VARCHAR(10) NULL,
    gasmaskengroesse VARCHAR(10) NULL,
    wehrnummer VARCHAR(50) NULL,
    signature_soldat MEDIUMTEXT NULL,
    signature_referent MEDIUMTEXT NULL,
    stamp_path TEXT NULL,
    soldbuch_details_pending TINYINT DEFAULT 0,
    soldbuch_details_edited_by INT NULL,
